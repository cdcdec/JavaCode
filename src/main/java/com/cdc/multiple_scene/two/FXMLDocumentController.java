package com.cdc.multiple_scene.two;
...
public class FXMLDocumentController implements Initializable {
    ...
    {
        Parent tableViewParent = FXMLLoader.load(getClass().getResource("/multiple_scene_two/ExampleOfTableView.fxml"));
        Scene tableViewScene = new Scene(tableViewParent);
        
        //This line gets the Stage information
        Stage window = (Stage)((Node)event.getSource()).getScene().getWindow();
        window.setTitle("ExampleOfTableView");
        window.setScene(tableViewScene);
        window.show();
    }

    public void changeScreenButtonMain(ActionEvent event) throws IOException
    {
        Main.backMain(event);
    }
